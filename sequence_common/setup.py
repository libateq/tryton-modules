...
setup_version()
setup(
    name='trytonlq_sequence_common',
    version='{major}.{minor}.{revision}'.format(**version),
    description=(
        "Tryton module that provides a common format for the standard "
        "sequences including unique prefixes and a uniform padding length"),
    ...
    keywords='tryton sequence common',
    package_dir={'trytond.modules.sequence_common': '.'},
    packages=(
        ['trytond.modules.sequence_common'] +
        ['trytond.modules.sequence_common.{}'.format(p)
    ...
    entry_points="""
    [trytond.modules]
    sequence_common = trytond.modules.sequence_common
    """,
    test_suite='tests',
