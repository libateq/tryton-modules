...
setup_version()
setup(
    name='trytonlq_account_uk_vat_analysis',
    ...
    keywords='tryton account uk vat analysis',
    package_dir={'trytond.modules.account_uk_vat_analysis': '.'},
    packages=(
        ['trytond.modules.account_uk_vat_analysis'] +
        ['trytond.modules.account_uk_vat_analysis.{}'.format(p)
