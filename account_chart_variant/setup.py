...
setup_version()
setup(
    name='trytonlq_account_chart_variant',
    ...
    keywords='tryton account chart variant',
    package_dir={'trytond.modules.account_chart_variant': '.'},
    packages=(
        ['trytond.modules.account_chart_variant'] +
        ['trytond.modules.account_chart_variant.{}'.format(p)
    ...
    entry_points="""
    [trytond.modules]
    account_chart_variant = trytond.modules.account_chart_variant
    """,
    test_suite='tests',
