...
setup_version()
setup(
    name='trytonlq_sale_direct',
    version='{major}.{minor}.{revision}'.format(**version),
    description="Tryton module that helps manage and track direct selling",
    ...
    keywords='tryton sale direct selling',
    package_dir={'trytond.modules.sale_direct': '.'},
    packages=(
        ['trytond.modules.sale_direct'] +
        ['trytond.modules.sale_direct.{}'.format(p)
    ...
    entry_points="""
    [trytond.modules]
    sale_direct = trytond.modules.sale_direct
    """,
    test_suite='tests',
