...
setup_version()
setup(
    name='trytonlq_account_uk_variants',
    version='{major}.{minor}.{revision}'.format(**version),
    description=(
        "Tryton module that provides variants to the UK charts of account for "
        "different company types and industry sectors"),
    ...
    keywords='tryton account uk variants',
    package_dir={'trytond.modules.account_uk_variants': '.'},
    packages=(
        ['trytond.modules.account_uk_variants'] +
        ['trytond.modules.account_uk_variants.{}'.format(p)
    ...
    entry_points="""
    [trytond.modules]
    account_uk_variants = trytond.modules.account_uk_variants
    """,
    test_suite='tests',
